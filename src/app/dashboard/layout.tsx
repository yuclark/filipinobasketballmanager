      ...
      <main className="ml-0 md:ml-60 flex-1 flex flex-col min-h-screen relative z-10 overflow-y-auto min-w-0">
        ...
        <header className="border-b border-zinc-900 bg-zinc-950/50 backdrop-blur-md px-6 py-4 flex items-center justify-between sticky top-0 z-20">
          ...
          <div className="flex items-center gap-3">
            <button
              onClick={handleLogout}
              className="hidden md:flex items-center gap-2 px-4 py-2 bg-zinc-900 hover:bg-zinc-850 text-zinc-400 hover:text-zinc-250 border border-zinc-800/85 hover:border-zinc-700/85 rounded-xl text-xs font-bold transition-all duration-200 cursor-pointer shadow-sm group"
            >
              <LogOut className="w-3.5 h-3.5 text-zinc-500 group-hover:text-zinc-400 transition-colors" />
